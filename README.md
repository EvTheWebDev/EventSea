...
## _Discover. Explore. Set Sail._

### The Creators

EventSea is created and maintained by [Ev Schmitt](https://evtheweb.dev) and [Jeremy Black](https://jereblack.dev/)

### About EventSea

EventSea is an app for students, _by students_. It is an event hub where different student organizations on a college campus can create an account, post events, and find collaborators and members easily. Orgs are able to communicate with each other, and can send announcements to their members with the push of a button.
...
git clone https://github.com/EvTheWebDev/EventSea.git
cd EventSea
...
- [x] Core event posting system
- [x] Event discovery and browsing
- [x] Organization account creation
- [x] Basic organization profile management
- [x] Event listing interface (UI implemented)
- [x] Static asset support for events and orgs
- [x] Student user profiles (follow orgs, track events, etc.) through Firebase
- [x] Firebase integration for persistent data
